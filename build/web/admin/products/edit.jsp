        ...
        <div class="space-y-3">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input name="product-price" value="${product.price}" required="true" class="w-full border-2 px-2 py-1 outline-none rounded-md border-black/60" placeholder="1.000.000" />
                </div>
                <div>
