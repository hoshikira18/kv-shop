<%-- 
    Document   : products
    Created on : Oct 9, 2024, 6:01:52 PM
    Author     : khuye
--%>
...
<html>
    ...
    <body>
        ...
        <div class="flex justify-center font-bold text-3xl">
            <h1>${product.proName}</h1>
        </div>
        <div class="flex justify-center">
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 inline-flex flex-col">
                <a href="#">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 inline-flex flex-col bg-gray-100 m-6">
                <div class="">
                    text
                </div>
            </div>
