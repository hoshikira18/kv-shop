<%-- 
    Document   : AlertOrderSuccess
    Created on : Oct 29, 2024, 8:33:29 PM
    Author     : VIET
--%>
        ...
        <main class="main">
            ...
            <section class="checkout section--lg">
                <div style="justify-content: center; display: flex">
                    <div class="justify-center border-solid rounded content-between content-between" 
                         style="border: solid; border-radius: 5px; width: 400px">
                        <h3 class="text-lg justify-center text-center" 
                            style="font-size: x-large; border-bottom: solid; padding: 10px
                            ; font-weight: bolder" >
                            Thông báo
                        </h3>
                        <div class="grid grid-cols-1 content-between">
                            <div style="text-align: center; padding: 10px; align-items: end" 
                                 class="font-bold text-black">
                                <p>Bạn đã đặt hàng thành công!</p>
                                <p>Cảm ơn bạn đã mua sản phẩm của chúng tôi.</p>
                            </div>
                            <div class=" justify-center flex" style="padding-bottom: 20px; margin: auto" >      
                                <a href="home" class="btn btn--md justify-center" 
