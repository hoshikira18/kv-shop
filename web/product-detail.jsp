                ...
                <div class="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1" id="menu">
                    <nav>
                        <ul class="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
                            <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="/shop/allProducts">Shop</a></li>
                            <li><a class="inline-block no-underline hover:text-black hover:underline py-2 px-4" href="/shop/allProducts">About</a></li>
                        </ul>
                    </nav>
                </div>
>>>>>>> 9f4b96181cabb3c6fc389638a619c8b15616fdcd
...
=======
        ...
        <!-- component -->
        <form action="/shop/addToCarts" method="GET"> 
                    ...
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div class="flex">
                                ...
                                <button class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded" type="submit">Add to Card</button>
