...
<html>
    ...
    <body class="bg-gray-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <form method="POST" action="" class="max-w-md mx-auto bg-white shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input name="addess" value="${user.getAddress()}" class="shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-gray-500" id="address" placeholder="123 Main St, City, Country"/>
                </div>
                <div class="mb-4">
